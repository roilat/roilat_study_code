...
import com.hansy.cmssite.common.config.Global;*/
...
public class ActiveMQUtil {
	protected static Log log = LogFactory.getLog(ActiveMQUtil.class);
	
	protected static String BROKER_URL = "activemq_broker_url";
