/* 
 * OrgAcctFlow.java created on 2016-08-17 下午 16:16:01 by roilatD
 */ 
 ...
 * 查询机构台账
 * TODO javadoc for com.hansy.dataservice.orgAcctFlow.entity.OrgAcctFlow
 * @Copyright: 2014海南易建科技股份有限公司
 * @author: roilatD
 * @since: 2016-08-17 下午 16:16:01
 */
@SuppressWarnings({"serial"})
@Alias("OrgAcctFlow")
public class OrgAcctFlow extends CommonBean<OrgAcctFlow> {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OrgAcctFlow other = (OrgAcctFlow) obj;
		if (flowId == null) {
	...
	public String toString() {
		return "OrgAcctFlow [ flowId=" + flowId + ", orgId=" + orgId + ", orgName=" + orgName + ", acctNo=" + acctNo + ", transAmt=" + transAmt + ", transTime=" + transTime + ", tansType=" + tansType + ", acctBal=" + acctBal + ", insertUser=" + insertUser + ", insertTime=" + insertTime + "]";
	}
}