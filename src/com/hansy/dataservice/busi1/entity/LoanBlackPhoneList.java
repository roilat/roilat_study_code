/* 
 * LoanBlackPhoneList.java created on 2016-08-17 下午 16:21:36 by roilatD
 */ 
 ...
 * 电话黑名单
 * TODO javadoc for com.hansy.dataservice.loanBlackPhoneList.entity.LoanBlackPhoneList
 * @Copyright: 2014海南易建科技股份有限公司
 * @author: roilatD
 * @since: 2016-08-17 下午 16:21:36
 */
@SuppressWarnings({"serial"})
@Alias("LoanBlackPhoneList")
public class LoanBlackPhoneList extends CommonBean<LoanBlackPhoneList> {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LoanBlackPhoneList other = (LoanBlackPhoneList) obj;
		if (tableKey == null) {
	...
	public String toString() {
		return "LoanBlackPhoneList [ tableKey=" + tableKey + ", phoneNum=" + phoneNum + ", certType=" + certType + ", certNo=" + certNo + ", listStatus=" + listStatus + ", listType=" + listType + ", remark=" + remark + ", createUser=" + createUser + ", createTime=" + createTime + ", checkUser=" + checkUser + ", checkTime=" + checkTime + ", cardNo=" + cardNo + "]";
	}
}