...
public class Lz4Test extends TestParent {
    ...
    @Benchmark
    public int testFastNative64K() throws Exception {
        return lz4(LZ4Factory.nativeInstance().fastCompressor(), BLOCK_64K );
    }

    @Benchmark
    public int testFastNative128K() throws Exception {
        return lz4(LZ4Factory.nativeInstance().fastCompressor(), BLOCK_128K );
    }

    @Benchmark
    public int testFastNative32M() throws Exception {
    ...
    @Benchmark
    public int testHighNative() throws Exception {
...
//    }
    ...
    @Benchmark
    public int testFastNativeDouble64K() throws Exception {
    ...
    @Benchmark
    public int testFastNativeDouble32M() throws Exception {
        final LZ4Compressor compressor = LZ4Factory.nativeInstance().fastCompressor();
        return baseBenchmark(new StreamFactory() {
            @Override
            public OutputStream getStream(OutputStream underlyingStream) throws IOException {
    ...
    @Benchmark
    public int testFastNativeTriple32M() throws Exception {
        final LZ4Compressor compressor = LZ4Factory.nativeInstance().fastCompressor();
        return baseBenchmark(new StreamFactory() {
            @Override
            public OutputStream getStream(OutputStream underlyingStream) throws IOException {
    ...
    private int lz4( final LZ4Compressor compressor, final int blockSize ) throws Exception
    {
        return baseBenchmark(new StreamFactory() {
            @Override
            public OutputStream getStream(OutputStream underlyingStream) throws IOException {
