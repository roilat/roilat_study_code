...
<body>
	<div>
		<form id="daysNodeForm" action="post">
		<table class="table_list">
			<tr>
				<td>nodeId</td>
				<td><input type="text" id="nodeId" name="nodeId" data-validaterole="nodeId" data-rule="nodeId" value="" /></td>
			</tr>
			<tr>
				<td>treeId</td>
				<td><input type="text" id="treeId" name="treeId" data-validaterole="treeId" data-rule="treeId" value="" /></td>
			</tr>
			<tr>
				<td>nodeNo</td>
				<td><input type="text" id="nodeNo" name="nodeNo" data-validaterole="nodeNo" data-rule="nodeNo" value="" /></td>
			</tr>
			<tr>
				<td>nodeValue</td>
				<td><input type="text" id="nodeValue" name="nodeValue" data-validaterole="nodeValue" data-rule="nodeValue" value="" /></td>
			</tr>
			<tr>
				<td>keyId</td>
				<td><input type="text" id="keyId" name="keyId" data-validaterole="keyId" data-rule="keyId" value="" /></td>
			</tr>
			<tr>
				<td colspan="2">
		...
		$(function(){
			...
			seajs.use(["component/validate","component/tip"], function (validate,tip) {
				...
				d.bind("onsubmit",function(){
					...
					$.post("${ctx}/daysNode/add.do", serializedForm, function (result) {
			            if ("succ" == result) {
			            	alert("操作成功");
							// 刷新列表页面
