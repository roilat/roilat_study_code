...
<body>
	<div>
		<form id="hqclcfTimelockForm" action="post">
		<table class="table_list">
			<tr>
				<td>年</td>
				<td><input type="text" id="year" name="year" data-validaterole="year" data-rule="year" value="" /></td>
			</tr>
			<tr>
				<td>月</td>
				<td><input type="text" id="month" name="month" data-validaterole="month" data-rule="month" value="" /></td>
			</tr>
			<tr>
				<td>是否上锁(0:否,1:是)</td>
				<td><input type="text" id="isLock" name="isLock" data-validaterole="isLock" data-rule="isLock" value="" /></td>
			</tr>
			<tr>
				<td>业务条线</td>
				<td><input type="text" id="businessLine" name="businessLine" data-validaterole="businessLine" data-rule="businessLine" value="" /></td>
			</tr>
			<tr>
				<td colspan="2">
		...
		$(function(){
			...
			seajs.use(["component/validate","component/tip"], function (validate,tip) {
				...
				d.bind("onsubmit",function(){
					...
					$.post("${ctx}/hqclcfTimelock/add.do", serializedForm, function (result) {
			            if ("succ" == result) {
			            	alert("操作成功");
							// 刷新列表页面
