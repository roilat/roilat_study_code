...
<body>
	<div>
		<form id="bizTypeForm" action="post">
		<table class="table_list">
			<tr>
				<td>参数类型值</td>
				<td><input type="text" id="typeCode" name="typeCode" data-validaterole="typeCode" data-rule="typeCode" value="" /></td>
			</tr>
			<tr>
				<td>参数类型名</td>
				<td><input type="text" id="typeName" name="typeName" data-validaterole="typeName" data-rule="typeName" value="" /></td>
			</tr>
			<tr>
				<td>主键</td>
		...
		$(function(){
			...
			seajs.use(["component/validate","component/tip"], function (validate,tip) {
				...
				d.bind("onsubmit",function(){
					...
					$.post("${ctx}/bizType/add.do", serializedForm, function (result) {
			            if ("succ" == result) {
			            	alert("操作成功");
							// 刷新列表页面
