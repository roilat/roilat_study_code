...
<body>
	<div>
		<form id="busiCodeForm" action="post">
		<table class="table_list">
			<tr>
				<td>参数类型</td>
				<td><input type="text" id="bizTypeCode" name="bizTypeCode" data-validaterole="bizTypeCode" data-rule="bizTypeCode" value="" /></td>
			</tr>
			<tr>
				<td>参数值</td>
				<td><input type="text" id="bizCodeValue" name="bizCodeValue" data-validaterole="bizCodeValue" data-rule="bizCodeValue" value="" /></td>
			</tr>
			<tr>
				<td>参数名</td>
				<td><input type="text" id="bizCodeName" name="bizCodeName" data-validaterole="bizCodeName" data-rule="bizCodeName" value="" /></td>
			</tr>
			<tr>
				<td>主键</td>
				<td><input type="text" id="id" name="id" data-validaterole="id" data-rule="id" value="" /></td>
			</tr>
			<tr>
				<td colspan="2">
		...
		$(function(){
			...
			seajs.use(["component/validate","component/tip"], function (validate,tip) {
				...
				d.bind("onsubmit",function(){
					...
					$.post("${ctx}/busiCode/add.do", serializedForm, function (result) {
			            if ("succ" == result) {
			            	alert("操作成功");
							// 刷新列表页面
