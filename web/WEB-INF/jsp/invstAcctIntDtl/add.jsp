...
<body>
	<div>
		<form id="invstAcctIntDtlForm" action="post">
		<table class="table_list">
			<tr>
				<td>txSeqNo</td>
				<td><input type="text" id="txSeqNo" name="txSeqNo" data-validaterole="txSeqNo" data-rule="txSeqNo" value="" /></td>
			</tr>
			<tr>
				<td>serlNo</td>
				<td><input type="text" id="serlNo" name="serlNo" data-validaterole="serlNo" data-rule="serlNo" value="" /></td>
			</tr>
			<tr>
				<td>invstNo</td>
			...
			<tr>
				<td>prftTyp</td>
				<td><input type="text" id="prftTyp" name="prftTyp" data-validaterole="prftTyp" data-rule="prftTyp" value="" /></td>
			</tr>
			<tr>
				<td>txDate</td>
			...
			<tr>
				<td>drCrFlag</td>
				<td><input type="text" id="drCrFlag" name="drCrFlag" data-validaterole="drCrFlag" data-rule="drCrFlag" value="" /></td>
			</tr>
			<tr>
				<td>estIncomeDt</td>
				<td><input type="text" id="estIncomeDt" name="estIncomeDt" data-validaterole="estIncomeDt" data-rule="estIncomeDt" value="" /></td>
			</tr>
			<tr>
				<td>estIncomeAmt</td>
				<td><input type="text" id="estIncomeAmt" name="estIncomeAmt" data-validaterole="estIncomeAmt" data-rule="estIncomeAmt" value="" /></td>
			</tr>
			<tr>
				<td>actualIncomeDt</td>
				<td><input type="text" id="actualIncomeDt" name="actualIncomeDt" data-validaterole="actualIncomeDt" data-rule="actualIncomeDt" value="" /></td>
			</tr>
			<tr>
				<td>actualIncomeAmt</td>
				<td><input type="text" id="actualIncomeAmt" name="actualIncomeAmt" data-validaterole="actualIncomeAmt" data-rule="actualIncomeAmt" value="" /></td>
			</tr>
			<tr>
				<td>paymentPpleAmt</td>
				<td><input type="text" id="paymentPpleAmt" name="paymentPpleAmt" data-validaterole="paymentPpleAmt" data-rule="paymentPpleAmt" value="" /></td>
			</tr>
			<tr>
				<td>actualPpleAmt</td>
				<td><input type="text" id="actualPpleAmt" name="actualPpleAmt" data-validaterole="actualPpleAmt" data-rule="actualPpleAmt" value="" /></td>
			</tr>
			<tr>
				<td>paymentIntAmt</td>
				<td><input type="text" id="paymentIntAmt" name="paymentIntAmt" data-validaterole="paymentIntAmt" data-rule="paymentIntAmt" value="" /></td>
			</tr>
			<tr>
				<td>actualIntAmt</td>
				<td><input type="text" id="actualIntAmt" name="actualIntAmt" data-validaterole="actualIntAmt" data-rule="actualIntAmt" value="" /></td>
			</tr>
			<tr>
				<td>txStat</td>
		...
		$(function(){
			...
			seajs.use(["component/validate","component/tip"], function (validate,tip) {
				...
				d.bind("onsubmit",function(){
					...
					$.post("${ctx}/invstAcctIntDtl/add.do", serializedForm, function (result) {
			            if ("succ" == result) {
			            	alert("操作成功");
							// 刷新列表页面
