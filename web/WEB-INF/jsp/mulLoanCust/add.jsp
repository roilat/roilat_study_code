...
<body>
	<div>
		<form id="mulLoanCustForm" action="post">
		<table class="table_list">
			...
			<tr>
				<td>借贷公司</td>
				<td><input type="text" id="loanCorp" name="loanCorp" data-validaterole="loanCorp" data-rule="loanCorp" value="" /></td>
			</tr>
			<tr>
				<td>插入时间</td>
		...
		$(function(){
			...
			seajs.use(["component/validate","component/tip"], function (validate,tip) {
				...
				d.bind("onsubmit",function(){
					...
					$.post("${ctx}/mulLoanCust/add.do", serializedForm, function (result) {
			            if ("succ" == result) {
			            	alert("操作成功");
							// 刷新列表页面
