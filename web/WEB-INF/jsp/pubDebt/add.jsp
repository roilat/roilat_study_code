...
<body>
	<div>
		<form id="pubDebtForm" action="post">
		<table class="table_list">
			<tr>
				<td>债券编号</td>
				<td><input type="text" id="debtNo" name="debtNo" data-validaterole="debtNo" data-rule="debtNo" value="" /></td>
			</tr>
			<tr>
				<td>原始产品编号</td>
			...
			<tr>
				<td>转让金额</td>
				<td><input type="text" id="debtAmt" name="debtAmt" data-validaterole="debtAmt" data-rule="debtAmt" value="" /></td>
			</tr>
			<tr>
				<td>转让类型</td>
				<td><input type="text" id="debtType" name="debtType" data-validaterole="debtType" data-rule="debtType" value="" /></td>
			</tr>
			<tr>
				<td>dedtFeeRat</td>
				<td><input type="text" id="dedtFeeRat" name="dedtFeeRat" data-validaterole="dedtFeeRat" data-rule="dedtFeeRat" value="" /></td>
			</tr>
			<tr>
				<td>折价率</td>
				<td><input type="text" id="discountRat" name="discountRat" data-validaterole="discountRat" data-rule="discountRat" value="" /></td>
			</tr>
			<tr>
				<td>实际收益率</td>
				<td><input type="text" id="prftRat" name="prftRat" data-validaterole="prftRat" data-rule="prftRat" value="" /></td>
			</tr>
			<tr>
				<td>原始产品金额</td>
			...
			<tr>
				<td>转让利息</td>
				<td><input type="text" id="dettolIntAmt" name="dettolIntAmt" data-validaterole="dettolIntAmt" data-rule="dettolIntAmt" value="" /></td>
			</tr>
			<tr>
				<td>产品剩余期数</td>
				<td><input type="text" id="debtPerd" name="debtPerd" data-validaterole="debtPerd" data-rule="debtPerd" value="" /></td>
			</tr>
			<tr>
				<td>产品开始时间</td>
			...
			<tr>
				<td>申请时间</td>
				<td><input type="text" id="applyDate" name="applyDate" data-validaterole="applyDate" data-rule="applyDate" value="" /></td>
			</tr>
			<tr>
				<td>转让时间</td>
				<td><input type="text" id="startDate" name="startDate" data-validaterole="startDate" data-rule="startDate" value="" /></td>
			</tr>
			<tr>
				<td>sellTmsp</td>
				<td><input type="text" id="sellTmsp" name="sellTmsp" data-validaterole="sellTmsp" data-rule="sellTmsp" value="" /></td>
			</tr>
			<tr>
				<td>截止时间</td>
				<td><input type="text" id="bidDueDate" name="bidDueDate" data-validaterole="bidDueDate" data-rule="bidDueDate" value="" /></td>
			</tr>
			<tr>
				<td>minInvstAmt</td>
				<td><input type="text" id="minInvstAmt" name="minInvstAmt" data-validaterole="minInvstAmt" data-rule="minInvstAmt" value="" /></td>
			</tr>
			<tr>
				<td>maxInvstAmt</td>
				<td><input type="text" id="maxInvstAmt" name="maxInvstAmt" data-validaterole="maxInvstAmt" data-rule="maxInvstAmt" value="" /></td>
			</tr>
			<tr>
				<td>转让状态</td>
				<td><input type="text" id="debtStat" name="debtStat" data-validaterole="debtStat" data-rule="debtStat" value="" /></td>
			</tr>
			<tr>
				<td>备注</td>
				<td><input type="text" id="prodRemk" name="prodRemk" data-validaterole="prodRemk" data-rule="prodRemk" value="" /></td>
			</tr>
			<tr>
				<td>创建日期</td>
		...
		$(function(){
			...
			seajs.use(["component/validate","component/tip"], function (validate,tip) {
				...
				d.bind("onsubmit",function(){
					...
					$.post("${ctx}/pubDebt/add.do", serializedForm, function (result) {
			            if ("succ" == result) {
			            	alert("操作成功");
							// 刷新列表页面
