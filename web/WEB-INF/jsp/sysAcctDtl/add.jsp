...
<body>
	<div>
		<form id="sysAcctDtlForm" action="post">
		<table class="table_list">
			...
			<tr>
				<td>strkFlag</td>
				<td><input type="text" id="strkFlag" name="strkFlag" data-validaterole="strkFlag" data-rule="strkFlag" value="" /></td>
			</tr>
			<tr>
				<td>strkDate</td>
				<td><input type="text" id="strkDate" name="strkDate" data-validaterole="strkDate" data-rule="strkDate" value="" /></td>
			</tr>
			<tr>
				<td>txCod</td>
		...
		$(function(){
			...
			seajs.use(["component/validate","component/tip"], function (validate,tip) {
				...
				d.bind("onsubmit",function(){
					...
					$.post("${ctx}/sysAcctDtl/add.do", serializedForm, function (result) {
			            if ("succ" == result) {
			            	alert("操作成功");
							// 刷新列表页面
