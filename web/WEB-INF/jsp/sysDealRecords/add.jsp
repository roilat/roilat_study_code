...
<body>
	<div>
		<form id="sysDealRecordsForm" action="post">
		<table class="table_list">
			...
			<tr>
				<td>收款账号</td>
				<td><input type="text" id="toAcctNo" name="toAcctNo" data-validaterole="toAcctNo" data-rule="toAcctNo" value="" /></td>
			</tr>
			<tr>
				<td>支付状态信息</td>
				<td><input type="text" id="payResult" name="payResult" data-validaterole="payResult" data-rule="payResult" value="" /></td>
			</tr>
			<tr>
				<td>平台处理结果</td>
				<td><input type="text" id="dealResult" name="dealResult" data-validaterole="dealResult" data-rule="dealResult" value="" /></td>
			</tr>
			<tr>
				<td>交易日期</td>
		...
		$(function(){
			...
			seajs.use(["component/validate","component/tip"], function (validate,tip) {
				...
				d.bind("onsubmit",function(){
					...
					$.post("${ctx}/sysDealRecords/add.do", serializedForm, function (result) {
			            if ("succ" == result) {
			            	alert("操作成功");
							// 刷新列表页面
